<template>
  <div class="hello">
    <header>
      ...
      <div class="right">
        <el-button type="primary btn">预览</el-button>
        <el-button
          type="success btn"
    ...
    <main>
      ...
      <div class="left">
        <div style="margin-bottom:12px">
          ...
          >
            <i
              ...
              style="font-size:20px;maigin-right:100px"
            ></i>
          </el-input>
        ...
        <div class="search">
          ...
          <div class="compile">
            <div class="title"><i class="el-icon-picture"></i></div>
            <div class="content">
              <div class="txt">
                <el-input
                  type="textarea"
                  style="height:100px"
                  placeholder="知人者智，自知者明。胜人者有力，自胜者强。"
                  v-model="textarea"
                  maxlength="250"
                  rows='4'
                  show-word-limit
                ...
                <div>
                  <el-input
                    size='mini'
                    style="width:200px;maegin-bottom:5px"
                    v-model="input"
                    placeholder="老子"
                  >老子</el-input>
                </div>
                <div>
                  <el-input
                    ...
                    style="width:200px"
                    v-model="input"
                    placeholder="发表于2019年人民日报"
                  >发表于2019年人民日报</el-input>
                </div>
        ...
        <div class="tool">
          <div>
            <i
              ...
              style="font-size:40px;color:#3367CC;margin-bottom:30px;"
            ></i>
          </div>
          <div>
            <i
        ...
        <div class="search">
          ...
          <div class="right-mb ">
            <div class="text">
              ...
              <p>老子,发表于2019年人民日报引用说明</p>
            </div>
          </div>
          <div class="right-mb video1">
            <video controls="controls" src="./../assets/video.mp4"></video>
          </div>
          <div class="right-mb">
            <div class="pic2"></div>
...
.search .p2 {
  width: 100%;
  height: 400px;
  background: url("./../assets/p2.jpg") no-repeat;
  background-size: cover;
  margin-bottom: 5px;
}
.search .p3 {
...
header {
  ...
  box-shadow: -3px -2px 20px 6px #d2d2d2;
  /* display: flex */
  position: fixed;
  margin-bottom: 21px;
  top: 0;
...
.right-mb .text p:nth-child(1){
  font-size: 18px;
	line-height: 27px;
	color: #000000;
}
.right-mb .text p:nth-child(2){
  font-size: 14px;
	line-height: 27px;
	color: #4f4f4f;
}
